...
def input_fn(is_training, data_dir, batch_size, num_epochs=1):
  ...
  # if is_training:
  #   dataset = dataset.shuffle(buffer_size=_FILE_SHUFFLE_BUFFER, seed=1)
  ...
  #   dataset = dataset.shuffle(buffer_size=_SHUFFLE_BUFFER, seed=1)
...
def main(unused_argv):
  ...
  for _ in range(FLAGS.train_epochs // FLAGS.epochs_per_eval):
    ...
    stop_hook = tf.train.StopAtStepHook(num_steps=1)
